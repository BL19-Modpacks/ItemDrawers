...
namespace kg_ItemDrawers
{
    ...
    public class ItemDrawers : BaseUnityPlugin
    {
        ...
        private static ConfigEntry<string> ExcludeList;
        public static HashSet<string> ExcludeSet = [];
        ...
        {
            _thistype = this;
            ExcludeList = config("General", "ExcludeList", "", "List of items to exclude in the drawer. Leave blank to include all items.");
        ...
        private void ResetList(object sender, EventArgs eventArgs) =>
            ExcludeSet = [..ExcludeList.Value.Replace(" ", "").Split(',')];
